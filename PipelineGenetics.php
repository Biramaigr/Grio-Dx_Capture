...
system("php $ngs_path/Scripts/Genetics_Capture/$mode/BWAM.php $serie $bwa_algo $is_pp $ngs_path $mode $length_min $is_indel_realign fastQ_group1 $bed $depth_variation_threshold $af_threshold $dp_threshold 1> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/output.txt 2> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/error.txt&");

system("php $ngs_path/Scripts/Genetics_Capture/$mode/BWAM.php $serie $bwa_algo $is_pp $ngs_path $mode $length_min $is_indel_realign fastQ_group2 $bed $depth_variation_threshold $af_threshold $dp_threshold 1> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/output.txt 2> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/error.txt&");

system("php $ngs_path/Scripts/Genetics_Capture/$mode/BWAM.php $serie $bwa_algo $is_pp $ngs_path $mode $length_min $is_indel_realign fastQ_group3 $bed $depth_variation_threshold $af_threshold $dp_threshold 1> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/output.txt 2> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/error.txt&");

system("php $ngs_path/Scripts/Genetics_Capture/$mode/BWAM.php $serie $bwa_algo $is_pp $ngs_path $mode $length_min $is_indel_realign fastQ_group4 $bed $depth_variation_threshold $af_threshold $dp_threshold 1> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/output.txt 2> $ngs_path/Genetics/RUNS/$serie/Analysis/Logs/error.txt&");
...
system("php $ngs_path/Scripts/Genetics_Capture/$mode/FinalStep.php $serie $ngs_path $mode $bed_name $dp_reseq $dp_conta $nm_file $bed");
...
#system("php $ngs_path/Scripts/Genetics_Capture/$mode/RenameBamsIndex.php $ngs_path/Genetics/RUNS/$serie/Analysis/Bams");
#system("php $ngs_path/Scripts/Genetics_Capture/$mode/RenameBamsIndex.php $ngs_path/Genetics/RUNS/$serie/Analysis/Bams_MEM");
