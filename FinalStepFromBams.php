...
system("php $ngs_path/Scripts/Genetics_Capture/$mode/All_SynthesisFromBams.php $ngs_path/Genetics/RUNS/$serie/Analysis/Resultats_mutacaller $ngs_path/Genetics/RUNS/$serie/Analysis/Resultats_deva $serie $ngs_path $mode $nm_file");
